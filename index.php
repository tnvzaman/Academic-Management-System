...
<html lang="en">
    ...
    <body>
        <div class="studlogin">
            ...
            If you are a faculty, <a href="faclogin.php" >log in here</a>
        </div>
        <?php
            ...
            if(isset($_POST["submit"]))
            {
                ...
                if($count>0)
                {
                    ...
                    $_SESSION['user']=$email;
                    echo("<script>location.href = '".SITEURL."stdhome.php';</script>");
                }
                else
                {
                    $_SESSION['login']="Email or Password Wrong, Try Again";
                    echo("<script>location.href = '".SITEURL."studlogin.php';</script>");
                }
            }
        ?>
    </body>